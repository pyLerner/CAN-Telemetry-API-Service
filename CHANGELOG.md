...
- Декодирование дверей T856 переведено на сообщение `0x18FF6527` по PDF §2.6 (поля opening/closed/closing), сверено с логами `debug/20260521/`.
- Удалены `door-map` и поддержка `0x1BFFD880`; в `etc/telemetry-provider.toml` заданы `doors = 0x18FF6527`, `io = 0x18FF6427`.
- Добавлены тесты на стабильные payload из `debug/20260521/*.log`.
