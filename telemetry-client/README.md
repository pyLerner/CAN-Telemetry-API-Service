...
- `true` — при первом успешном опросе в лог попадает текущее состояние **каждой** двери.
...
python3 door_logger.py -h 192.168.9.220 -p 7080 --interval 1 -i false -u false -t utc
```
